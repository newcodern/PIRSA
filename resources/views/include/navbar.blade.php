          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="#">
                ...
                <span><form method="post" action="{{route('auth.Bottomadmin.logout')}}">@csrf <button type="submit" id="logout_bridge" hidden></button>   <label style="cursor: pointer;" class="item-sb" for="logout_bridge" href="#">Logout</label></form></span>
              </a>
            </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="#">
                <i class="bi bi-box-arrow-right"></i>
                <span><form method="post" action="{{route('auth.ASecurity.logout')}}">@csrf <button type="submit" id="logout_bridge" hidden></button>   <label style="cursor: pointer;" class="item-sb" for="logout_bridge" href="#">Logout</label></form></span>
              </a>
            </li>
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
          <i class="bi bi-menu-button-wide"></i><span>Flowchart Security</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      </li>
      <li class="nav-item">
